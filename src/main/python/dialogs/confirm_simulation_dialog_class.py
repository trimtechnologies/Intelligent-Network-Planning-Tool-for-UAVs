...
class ConfirmSimulationDialogClass(QDialog):
    ...
    def __init__(self, data: dict, parent=None):
        ...
        print('entity=', transmitter['entidade'])
        print('uf_municipal=', transmitter['uf_municipio'])
        print('address=', transmitter['endereco'])
        print('frequency=', transmitter['frequencia'])
        print('gain=', transmitter['ganho'])
        print('transmission power=', transmitter['potencia_transmissao'])
        print('elevation=', transmitter['elevacao'])
        print('polarization=', transmitter['polarizacao'])
        print('height=', transmitter['altura'])
        print('latitude=', transmitter['latitude'])
        print('longitude=', transmitter['longitude'])

        receptor = data['receptor']
        print('height=', receptor['altura'])
        print('gain=', receptor['ganho'])
        print('sensitivity=', receptor['sensibilidade'])

        heuristic = data['heuristic']
        print('initial solution=', heuristic['solucao_inicial'])
        print('initial temperature=', heuristic['temperatura_inicial'])
        print('maximum_number_of_iterations=', heuristic['numero_maximo_iteracoes'])
        print('maximum_number_of_disturbances_per_iteration=', heuristic['numero_maximo_pertubacoes_por_iteracao'])
        print('maximum_number_of_successes_per_iteration=', heuristic['numero_maximo_sucessos_por_iteracao'])
